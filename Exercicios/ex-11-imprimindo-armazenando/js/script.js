...
if(numero1 >= 0 && numero2 >= 0 ){
    ...
    alert('Este número ou palavra não corresponde a um número positivo')
}
...
alert("Números digitados: " + numero1 + ", " + numero2 + " " + "Resultado da divisão: " + resultado);
*/
